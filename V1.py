...
def view_trend(ticker):
    ...
    return ticker, input_start, input_end, graph_choice, 10, "view_trend_next"  
def next_request():
    ...
    while True:
        ...
        if next_step == 1:
            print("Returning to main menu...")
            return "Return to menu", next_step
...
def main():
    ...
    input_keyword, ticker, check_code_next = check_code()
    ticker,input_start,input_end,graph_choice,ma,view_trend_next = view_trend(ticker)
